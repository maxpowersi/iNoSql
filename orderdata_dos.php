   ...
   <?php include("nav.php");?>
    ...
    <div class="container">
		<div class="page-header" style="padding-top: 20px;">
			<h1>Prueba 4 - Búsqueda de órdenes</h1>
			<h4>Ingresa en el formulario el número de órden a buscar. Para ver la explicación <a href="orderdata_dos_res.php">acá</a></h4>
		</div>
		<div>	
