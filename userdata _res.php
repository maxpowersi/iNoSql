...
<body>
   <?php include("nav.php"); ?>
    <div class="container">
		...
		<div>
			<p class="lead">En el primer ejemplo veremos la tipica inyección sql llevada a NoSql. La inyección tradicional ' OR '1' = '1 la transformamos a una sintaxis javascript  con lo cual nos queda ' || '1' == '1</p>
