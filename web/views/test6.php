...
<script type="text/javascript">
    function enviar()
    {
            var response = $.ajax({
                                    type: "POST",
                                    url: "/inosql/web/test6_server.php",
...
<div class="container">
    <div class="page-header" style="padding-top: 20px;">
        ...
        <h4>Ingresa en el formulario las credenciales de autenticación, por ejemplo el nombre de usuario es admin. <a href="test6_res.php" target="_blank">Respuesta</a></h4>
    </div>
    <div>	
        <form method="get">
