   ...
   <?php include("nav.php"); ?>
    <div class="container">
		<div class="page-header" style="padding-top: 20px;">
			<h1>Prueba 2 - Búsqueda de ordenes - Explicación </h1>
		</div>
		<div>
			<p class="lead">En el primer ejemplo vimos la tipica inyección sql llevada a NoSql. En este caso la inyección es un poco mas complicada, ya que la misma tiene el parametro concatenado en el medio y no al final.</p>
